...
func (_m *LogInformer) IsInitialized() bool {
	ret := _m.Called()
...
// LogInformer_IsInitialized_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'IsInitialized'
type LogInformer_IsInitialized_Call struct {
	*mock.Call
}

// IsInitialized is a helper method to define mock.On call
func (_e *LogInformer_Expecter) IsInitialized() *LogInformer_IsInitialized_Call {
	return &LogInformer_IsInitialized_Call{Call: _e.mock.On("IsInitialized")}
}

func (_c *LogInformer_IsInitialized_Call) Run(run func()) *LogInformer_IsInitialized_Call {
...
func (_c *LogInformer_IsInitialized_Call) Return(_a0 bool) *LogInformer_IsInitialized_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *LogInformer_IsInitialized_Call) RunAndReturn(run func() bool) *LogInformer_IsInitialized_Call {
	_c.Call.Return(run)
	return _c
}
