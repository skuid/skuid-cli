...
var (
	...
	pagePackCmd = &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			err = pagePack.WritePagePack(ArgOutputFileName, pagePackModule)
...
func init() {
	...
	AddFlags(pagePackCmd, AddFlagHost, AddFlagClientId, AddFlagPassword, AddFlagUsername, AddFlagOutputFilename)
}
