...
wget https://github.com/skuid/skuid/releases/download/0.3.2/skuid_darwin_amd64 -O skuid
# On a Linux machine? Use this instead:
# wget https://github.com/skuid/skuid/releases/download/0.3.2/skuid_linux_amd64 -O skuid
